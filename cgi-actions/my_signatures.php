            ...
            <div class="col-7 clear-content" style="position: relative; margin-left: 21%; margin-top: 10%">
                <div class="container container-fluid filter-container">
                    <div class="filter-row row">
                        <div class="col-md-12 col-filters">
                            <div class="form filters">
                                <div class="row form-row">
                                    <div class="col-12">
                                        <div class="input-group input-group-inline in-sep-input">
                                            <div class="input-group-prepend">
                                                <label for="filter-main" class="form-label">Filter by</label>
                                            </div>
                                            <select class="form-control" name="filter" id="filter-main">
                                                <option value="0">No filter</option>
                                                <option value="11">Newest firts</option>
                                                <option value="12">Oldest firts</option>
                                                <option value="13">MD5 Only</option>
                                                <option value="14">SHA1 Only</option>
                                                <option value="15">SHA256 Only</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                ...
                <br>
                <div class="" id="dispose-items"></div>
                <br>
